...
public class MyOldExternalSignature implements ExternalSignature {
    Logger logger = LoggerFactory.getLogger(com.mjh.adapter.signing.utils.MyOldExternalSignature.class);
    ...
    public MyOldExternalSignature(String profileName, String signingUrl, String hashAlgorithm, String jwToken, String refToken, String keyId, String shaChecksum, String retryFlag) {
    ...
    public byte[] sign(byte[] bytes) throws SignAdapterException {
        ...
        try {
            return Base64.decode(MyUtil.POSTHashRequestResponse(this.signingUrl, this.profileName, MyUtil.utilBase64encode(bytes), this.jwToken, this.refToken, this.keyId, this.shaChecksum, this.retryFlag));
