...
public class ValidationUtils {
        ...
        public static X509CRL fetchCRLFromURL(URL url) throws CommonException {
        ...
        private static X509CRL fetchCRLFromURLwithRetry(URL url, CertificateFactory certFactory, int retries, long waitTime) throws CommonException {
            X509CRL result = null;
            CommonException lastException = null;
        ...
        public static X509CRL fetchCRLFromURL(URL url,
                                              CertificateFactory certFactory) throws CommonException {
        ...
        public static OCSPResponse queryOCSPResponder(URL url, OCSPReq request) throws IOException, OCSPException {
            ...
            final DERTaggedObject to = (DERTaggedObject)id.toASN1Primitive().toASN1Object();
            final RespID respId;
